...
* **Werteanspruch:** [`docs/prinzipien-lizenzen-richtlinien/werteanspruch-beNetX-DotMesh-Architektur-v1.0.md`](./docs/prinzipien-lizenzen-richtlinien/werteanspruch-beNetX-DotMesh-Architektur-v1.0.md) (Link zur Datei im Repository anpassen)
...
* **Urhebernachweis & Lizenz:** [`docs/prinzipien-lizenzen-richtlinien/benetx_urheber_dotmesh_architektur_v1_signiert.pdf`](./docs/prinzipien-lizenzen-richtlinien/benetx_urheber_dotmesh_architektur_v1%20signiert.pdf) (Link zur Datei im Repository anpassen) [cite: 1, 5]
* **Manifest I (Ursprung & No-House Ontologie):** Erklärt die Grundidee der "heimatlosen" Daten. (Link zum entsprechenden Manifest-Dokument hier einfügen)
* **Manifest II (These der raumlosen Daten):** Vertieft das Konzept, dass Bedeutung unabhängig vom Ort ist. (Link zum entsprechenden Manifest-Dokument hier einfügen) [cite: 2426, 2427]
* **Manifest III (Sinn, Information und der zweite Lebenszyklus):** Beschreibt, wie Informationen durch Sinn dialogfähig werden. (Link zum entsprechenden Manifest-Dokument hier einfügen) [cite: 2431, 2432]
